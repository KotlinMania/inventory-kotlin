...
kotlin {
    ...
    val xcf = XCFramework("Inventory")

    macosArm64 {
        binaries.framework { baseName = "Inventory"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Inventory"; xcf.add(this) }
    }
    ...
    swiftExport {
        ...
        flattenPackage = "io.github.kotlinmania.inventory"
    }

    android {
        namespace = "io.github.kotlinmania.inventory"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "inventory-kotlin", version.toString())

    pom {
        name.set("inventory-kotlin")
        description.set("Kotlin Multiplatform port of dtolnay/inventory - Typed distributed plugin registration")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/inventory-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/inventory-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/inventory-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/inventory-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleInventoryXCFramework",
    "assembleInventoryDebugXCFramework",
    "assembleInventoryReleaseXCFramework",
    "assembleDebugIosFatFrameworkForInventoryXCFramework",
    "assembleReleaseIosFatFrameworkForInventoryXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForInventoryXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForInventoryXCFramework",
    "assembleDebugMacosFatFrameworkForInventoryXCFramework",
    "assembleReleaseMacosFatFrameworkForInventoryXCFramework",
    "assembleDebugTvosFatFrameworkForInventoryXCFramework",
    "assembleReleaseTvosFatFrameworkForInventoryXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForInventoryXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForInventoryXCFramework",
    "assembleDebugWatchosFatFrameworkForInventoryXCFramework",
    "assembleReleaseWatchosFatFrameworkForInventoryXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForInventoryXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForInventoryXCFramework",
