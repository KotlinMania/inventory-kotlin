...
This file is the quick-reference operating contract for inventory-kotlin. The longer
...
inventory-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`inventory`](https://crates.io/crates/inventory). Upstream Rust is the behavioral oracle while the
